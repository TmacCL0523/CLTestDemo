...
#endif
#define SocketPort          @"" //线上


@interface WebSocketTools ()<SRWebSocketDelegate>
...
@end
@implementation WebSocketTools

+ (instancetype)shared {
    static WebSocketTools *__instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        __instance = [[WebSocketTools alloc] init];
    });
    return __instance;
}
...
- (void)connectServer {
    ...
    self.webScoket = [[SRWebSocket alloc] initWithURL:[NSURL URLWithString:self.port]];
