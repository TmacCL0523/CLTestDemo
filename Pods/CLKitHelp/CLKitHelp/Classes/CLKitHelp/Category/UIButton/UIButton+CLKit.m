                         ...
                         cornerRadius:(CGFloat)cornerRadius
{
    ...
    [button setImage:nonarlImage forState:UIControlStateNormal];
...
+ (instancetype)clKitButtonWithTitle:(NSString *)title
                         ...
                         cornerRadius:(CGFloat)cornerRadius
{
    return [self clKitButtonWithTitle:title backColor:backColor nonarlImage:nil selectImage:nil titleColor:color font:font cornerRadius:cornerRadius];
}
...
+ (instancetype)clKitButtonWithImage:(UIImage *)nonarlImage
                         ...
                         cornerRadius:(CGFloat)cornerRadius
{
    return [self clKitButtonWithTitle:nil backColor:nil nonarlImage:nonarlImage selectImage:selectImage titleColor:nil font:nil cornerRadius:cornerRadius];
}
...
{
    objc_setAssociatedObject(self, &ActionTag, touchHandler, OBJC_ASSOCIATION_COPY_NONATOMIC);
...
- (UIEdgeInsets)clKitEdgeInsets
{
    return [objc_getAssociatedObject(self, @selector(clKitEdgeInsets)) UIEdgeInsetsValue];
}

//- (void)setClickEdgeInsets:(UIEdgeInsets)clickEdgeInsets
-(void)setClKitEdgeInsets:(UIEdgeInsets)clKitEdgeInsets
{
    objc_setAssociatedObject(self, @selector(clKitEdgeInsets), [NSValue valueWithUIEdgeInsets:clKitEdgeInsets], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (BOOL)pointInside:(CGPoint)point withEvent:(UIEvent *)event
{
    if (UIEdgeInsetsEqualToEdgeInsets(self.clKitEdgeInsets, UIEdgeInsetsZero)) {
        return [super pointInside:point withEvent:event];
    } else {
        CGRect large = UIEdgeInsetsInsetRect(self.bounds, self.clKitEdgeInsets);
...
{
    TouchedButtonBlock blockAction = (TouchedButtonBlock)objc_getAssociatedObject(self, &ActionTag);
    if (blockAction) {
        blockAction();
    }
}
